...
export default function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0E0E0E] text-[#F0F0F0] font-sans flex flex-col justify-center px-6 sm:px-6 lg:px-8 overflow-hidden select-none">
      ...
      <div className="mt-8 md:mt-12 mx-auto w-full max-w-sm">
        <div className="bg-white/5 py-8 px-5 sm:px-8 rounded-3xl border border-white/10 backdrop-blur-md">
          {successMsg && (
            <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs rounded-xl font-bold uppercase tracking-wider">
              {successMsg}
            </div>
          )}
          {errorMsg && (
            <div className="mb-6 p-4 bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs rounded-xl font-bold uppercase tracking-wider">
              {errorMsg}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-4 bg-black/50 border border-white/10 rounded-xl focus:ring-1 focus:ring-[#FFD700] focus:border-[#FFD700] text-sm transition-all text-[#F0F0F0] placeholder-white/20"
                  placeholder="isim@sirket.com veya kullanıcı adı"
                />
              </div>
            </div>
